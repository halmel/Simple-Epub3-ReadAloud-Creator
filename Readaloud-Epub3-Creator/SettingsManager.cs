...
namespace Readaloud_Epub3_Creator
{
    public class AppSettings
    {
        ...
        {
            get => string.IsNullOrWhiteSpace(_ebooksPath)
                ? Path.GetFullPath(Path.Combine(_baseDir, @"..\..\..\..\Ebooks"))
                : _ebooksPath;
        ...
        {
            get => string.IsNullOrWhiteSpace(_transcriberPath)
                ? Path.GetFullPath(Path.Combine(_baseDir, @"..\..\..\..\Transcriber\transcriber.py"))
                : _transcriberPath;
